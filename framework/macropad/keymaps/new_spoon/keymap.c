...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     /*
     *         ┌───────┬───────┬───────┬───────┐
     *  4 keys │Numpad │Arrows │ Docs  │ Words │
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │  RGB  │   /   │   X   │   -   │
     *         │       │       │       │       │
    ...
    [0] = LAYOUT(   //Numpad
        TO(0),         TO(1),         TO(2),             TO(3),
        RGB_VAI,       KC_SLASH,      KC_ASTERISK,       KC_MINUS,
        KC_7,          KC_8,          KC_9,              KC_PLUS,
        KC_4,          KC_5,          KC_6,              KC_PERCENT,
        KC_1,          KC_2,          KC_3,              KC_EQUAL,
        KC_BACKSPACE,  KC_0,          KC_DOT,            KC_ENTER
    ),
     /*
     *         ┌───────┬───────┬───────┬───────┐
     *  4 keys │Numpad │Arrows │ Docs  │ Words │
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │  RGB  │Insert │Scroll │ Print │
     *         │       │       │ Lock  │Screen │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │       │       │       │       │
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │ Home  │ Page  │ Page  │  End  │
     *         │       │  Up   │ Down  │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │       │  Up   │       │       │
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │ Left  │ Down  │ Righ  │ Enter │
     *         │       │       │       │       │
     *         └───────┴───────┴───────┴───────┘
     * 24 total
     */
     ...
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │ Bold  │Italic │ Under │Strike │
     *         │       │       │ Score │Through│
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │ Left  │Center │ Right │ Word  │
     *         │ Align │ Align │ Align │ Count │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │Heading│Heading│       │Bullet │
     *         │   4   │   5   │       │ List  │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │Heading│Heading│Heading│Number │
     *         │   1   │   2   │   3   │ List  │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │       │Heading│       │ Enter │
     *         │       │   0   │       │       │
     *         └───────┴───────┴───────┴───────┘
     * 24 total
     */
     ...
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │  RGB  │  New  │ Close │ReOpen │
     *         │       │  Tab  │  Tab  │  Tab  │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │ Undo  │ Redo  │       │       │
     *         │       │       │       │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │Desktop│Desktop│Desktop│       │
     *         │   4   │   5   │   6   │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │Desktop│Desktop│Desktop│       │
     *         │   1   │   2   │   3   │       │
     *         ├───────┼───────┼───────┼───────┤
     *  4 keys │Notepad│ Files │ Term  │ Enter │
     *         │       │       │       │       │
     *         └───────┴───────┴───────┴───────┘
     * 24 total
     */
...
bool rgb_matrix_indicators_user(void) {
	if (layer_state_cmp(layer_state, _NUMPAD)) {
		// Numpad 
	...
	if (layer_state_cmp(layer_state, _ARROWS)) {
        // Arrows 
        rgb_matrix_set_color(4,  RGB_WHITE);        // RGB      C1 R2
    ...
    if (layer_state_cmp(layer_state, _DOCS)) {
        // Docs 
    ...
    if (layer_state_cmp(layer_state, _WINDOWS)) {
        // Windows 
        rgb_matrix_set_color(4,  RGB_WHITE);        // RGB      C1 R2
